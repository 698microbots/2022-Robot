...
public class PixyCam extends SubsystemBase {
  ...
  public PixyCam() {
    ...
    blockCount = pixy2.getCCC().getBlocks(false, 1, 255);//wait for next frame with target object, the signature of object(1 is red, 2 is blue), how many object tracking?
